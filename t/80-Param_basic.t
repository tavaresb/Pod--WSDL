...
eval { my $a1 = Pod::WSDL::Param->new(); };

ok( defined $@, 'new dies, if it does not get a string' );

eval { my $a1 = Pod::WSDL::Param->new('myParam $string blah blah ...'); };

ok(
    defined $@,
    'new dies, if it does not get a string beginning with _IN, _OUT, or _INOUT'
);

eval { my $a1 = Pod::WSDL::Param->new('_IN myParam string blah blah ...'); };

ok( defined $@, 'new dies, if array/scalar type is not specified' );

my $a1 = Pod::WSDL::Param->new('_IN myParam $string blah blah ...');
